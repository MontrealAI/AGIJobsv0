...
const configSchema = z.object({
  ...
  influenceValidationMultiplier: z
    ...
    .pipe(z.number().positive())
    .optional(),
  weeklyMetricsOutput: z
    .string()
    .default('storage/culture-graph-indexer/weekly-metrics.latest.json'),
...
export function loadConfig(): IndexerConfig {
  const result = configSchema.safeParse({
    ...
    weeklyMetricsOutput:
      process.env.CULTURE_WEEKLY_METRICS ??
      process.env.INDEXER_WEEKLY_METRICS ??
      process.env.CULTURE_ANALYTICS_EXPORT,
