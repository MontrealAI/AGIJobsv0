...
function parseReference(entry: string): { path: string; description: string } {
...
function parseArgs(argv: string[]): CliOptions {
  const options: CliOptions = {
    reportRoot: path.join(ROOT, 'reports', 'asi-global'),
    planPath: path.join(ROOT, 'demo', 'asi-global', 'project-plan.json'),
