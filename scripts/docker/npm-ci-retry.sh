...
# lockfile relative to the intended project root. Afterwards explicitly pin the
# local prefix so npm resolves manifests from the targeted workspace even if
# upstream environments exported custom prefixes.
