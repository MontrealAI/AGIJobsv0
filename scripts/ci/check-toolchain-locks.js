...
function checkWorkflows() {
  ...
  for (const file of workflowFiles) {
    ...
    if (contents.includes("actions/setup-node")) {
      const hasNvmrc = contents.includes("node-version-file: '.nvmrc'") || contents.includes('node-version-file: ".nvmrc"');
...
console.log("✅ Toolchain lock verification passed. All required versions are pinned.");
