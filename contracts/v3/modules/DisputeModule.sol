...
contract DisputeModule is Ownable, Pausable {
    ...
    /// @dev The full evidence must be stored off-chain (e.g., IPFS) and its keccak256 hash provided here. Only the hash is stored and emitted on-chain to keep costs low.
