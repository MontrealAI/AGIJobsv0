...
SCOPE="${AURORA_REPORT_SCOPE:-global-orchestrator}"
REPORT_DIR="reports/${NET}/${SCOPE}/receipts"
DEPLOY_OUTPUT="${AURORA_DEPLOY_OUTPUT:-${REPORT_DIR}/deploy.json}"
MISSION_CONFIG="${AURORA_MISSION_CONFIG:-demo/global-orchestrator/config/mission@v2.json}"
THERMOSTAT_CONFIG="${AURORA_THERMOSTAT_CONFIG:-demo/global-orchestrator/config/global-orchestrator.thermostat@v2.json}"
REPORT_TITLE="${AURORA_REPORT_TITLE:-Global Autonomous Economic Orchestrator — Mission Report}"
...
LOG_FILE="/tmp/global-orchestrator-node.log"
start_node "$LOG_FILE"
