...
async function bootstrap() {
  try {
    const [telemetry, ledger] = await Promise.all([
      fetchJson("./output/stellar-telemetry.json"),
      fetchJson("./output/stellar-stability-ledger.json"),
    ]);
    ...
    renderLedger(ledger);
    await renderMermaidDiagram("./output/stellar-mermaid.mmd", "mermaid-container", "stellar-diagram");
    await renderMermaidDiagram("./output/stellar-dyson.mmd", "dyson-container", "stellar-dyson-diagram");
  } catch (error) {
    console.error(error);
