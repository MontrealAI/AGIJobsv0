...
from .config import OmegaOrchestratorV5Config
...
class OmegaUpgradeV5Orchestrator(OmegaUpgradeOrchestrator):
    """Augmented orchestrator that adds long-run autonomy management."""

    config: OmegaOrchestratorV5Config

    def __init__(self, config: OmegaOrchestratorV5Config) -> None:
