...
from .config import OmegaOrchestratorV4Config
...
class AutonomyGuardian:
    ...
    async def evaluate(self, orchestrator: "OmegaUpgradeV4Orchestrator") -> Dict[str, Any]:
    ...
    async def _broadcast_expedite(
        self, job_ids: Sequence[str], orchestrator: "OmegaUpgradeV4Orchestrator"
    ) -> None:
    ...
    def _resource_pressure(self, orchestrator: "OmegaUpgradeV4Orchestrator") -> Dict[str, float]:
...
class OmegaUpgradeV4Orchestrator(OmegaUpgradeOrchestrator):
    """Augmented orchestrator that adds long-run autonomy management."""

    config: OmegaOrchestratorV4Config

    def __init__(self, config: OmegaOrchestratorV4Config) -> None:
...
__all__ = ["OmegaUpgradeV4Orchestrator"]
