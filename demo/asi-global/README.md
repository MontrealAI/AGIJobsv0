...
4. When rehearsing locally with Anvil, export `AURORA_LOCAL_GAS_LIMIT` and `AURORA_LOCAL_CODE_SIZE_LIMIT` (defaults: `1_000_000_000` gas, `1_048_576` bytes) so oversized mission contracts deploy without tripping legacy block constraints.
