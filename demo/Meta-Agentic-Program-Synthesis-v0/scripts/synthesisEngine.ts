  ...
  return {
    ...
    aggregate: {
      ...
      ownerSupremacy: {
        ...
        commandDeclared: capabilityDeclarations,
        commandAvailable: 0,
        commandAvailability: capabilityDeclarations > 0 ? 0 : 1,
        verificationDeclared: capabilityDeclarations,
        verificationAvailable: 0,
        verificationAvailability: capabilityDeclarations > 0 ? 0 : 1,
        declaredScripts,
        availableScripts: 0,
