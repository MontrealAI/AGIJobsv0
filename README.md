...
- **Companion workflows:** Static analysis, fuzzing, web application smoke tests, orchestrator rehearsals, deterministic e2e drills, and the Zenith Sapience OmniDominion rehearsal are all surfaced as required checks so the Checks tab stays comprehensible to non-technical stakeholders. Each badge above links directly to its workflow for live status and history.【F:.github/workflows/static-analysis.yml†L1-L157】【F:.github/workflows/fuzz.yml†L1-L144】【F:.github/workflows/webapp.yml†L1-L196】【F:.github/workflows/orchestrator-ci.yml†L1-L214】【F:.github/workflows/e2e.yml†L1-L164】【F:.github/workflows/demo-zenith-sapience-omnidominion.yml†L1-L67】
...
- Zenith Sapience OmniDominion rehearsals now draw their validator and worker keys from repository secrets with deterministic fallbacks, letting contract owners rotate credentials without code changes while keeping the workflow YAML valid for GitHub's parser.【F:.github/workflows/demo-zenith-sapience-omnidominion.yml†L55-L67】
