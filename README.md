...
- Supply `--output reports/ci/status-wall.json` to export an auditable snapshot (use `--format markdown` for a table) so governance teams can archive the live signal alongside the artefacts generated by CI v2.
