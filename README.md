...
### Validator Workflow
  ...
  - **Staking requirement** – bond $AGI via [`stake`](contracts/AGIJobManagerv1.sol#L1380-L1385) and exit with [`withdrawStake`](contracts/AGIJobManagerv1.sol#L1387-L1406), emitting [`StakeDeposited`](contracts/AGIJobManagerv1.sol#L318) and [`StakeWithdrawn`](contracts/AGIJobManagerv1.sol#L319).
  - **Commit → reveal → finalize** – submit a hashed vote with [`commitValidation`](contracts/AGIJobManagerv1.sol#L445-L479), disclose it via [`revealValidation`](contracts/AGIJobManagerv1.sol#L485-L514), then call [`validateJob`](contracts/AGIJobManagerv1.sol#L520-L549) or [`disapproveJob`](contracts/AGIJobManagerv1.sol#L554-L580) once the review window closes. These steps emit [`ValidationCommitted`](contracts/AGIJobManagerv1.sol#L260), [`ValidationRevealed`](contracts/AGIJobManagerv1.sol#L261), [`JobValidated`](contracts/AGIJobManagerv1.sol#L257), and [`JobDisapproved`](contracts/AGIJobManagerv1.sol#L258).
  - **Slashing & rewards** – correct validators split [`validationRewardPercentage`](contracts/AGIJobManagerv1.sol#L822-L826) of escrow plus any slashed stake, while incorrect votes lose [`slashingPercentage`](contracts/AGIJobManagerv1.sol#L873-L877) and may trigger `StakeSlashed`. Final approval emits [`JobFinalizedAndBurned`](contracts/AGIJobManagerv1.sol#L265-L272).
  - **Pool rotation** – the contract owner can replace the entire validator list with [`setValidatorPool`](contracts/AGIJobManagerv1.sol#L1317-L1333); validators are then assigned round-robin from this pool for each job.
  - **Owner controls** – validator settings are adjustable via [`setValidatorConfig`](contracts/AGIJobManagerv1.sol#L930-L963) or individual setters like [`setStakeRequirement`](contracts/AGIJobManagerv1.sol#L865-L868), [`setSlashingPercentage`](contracts/AGIJobManagerv1.sol#L873-L877), [`setValidationRewardPercentage`](contracts/AGIJobManagerv1.sol#L822-L826), [`setMinValidatorReputation`](contracts/AGIJobManagerv1.sol#L879-L881), and [`setSlashedStakeRecipient`](contracts/AGIJobManagerv1.sol#L857-L860), each emitting their respective `*Updated` events. `setValidatorConfig` additionally sets commit, reveal, and review windows plus the number of validators per job.
