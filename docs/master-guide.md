...
- **Fee remittance (M):** `finalizeJobFunds(jobId, agent, reward, fee, feePool, employer)` → net to agent, validator rewards, fee to `FeePool`; burns only after employer-initiated finalization.
