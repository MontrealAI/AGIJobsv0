...
- Personal access token with `repo` and `admin:repo_hook` scopes for GitHub’s GraphQL API.
- Local environment with Node.js 20.18.1 and the repository dependencies installed via
  `npm ci`.
