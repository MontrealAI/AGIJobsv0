...
| `containers / build`                  | [`containers.yml`](../.github/workflows/containers.yml) | Confirms every production image builds under hardened scanning defaults so deployers and operators always have a green artifact.【F:.github/workflows/containers.yml†L1-L98】 |
