...
2. The devcontainer provides Node.js 20.19.x, npm 11, Foundry (`forge`, `anvil`), Python 3.12, Docker CLI (DinD), and cached npm/pip layers matching CI.
...
1. Install prerequisites:
   ...
   - **Node.js 20.19.x** (`nvm install 20.19.0 && nvm alias default 20.19.0`)
